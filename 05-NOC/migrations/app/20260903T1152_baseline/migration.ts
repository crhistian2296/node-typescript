#!/usr/bin/env -S node
import type { Contract as End } from '../../snapshots/16c9cc80ef404eb3a841e58a979ae04cc46a1be34c1920abe6d4d7d5d84c0eef/contract';
import endContract from '../../snapshots/16c9cc80ef404eb3a841e58a979ae04cc46a1be34c1920abe6d4d7d5d84c0eef/contract.json' with { type: 'json' };
import {
  Migration,
  MigrationCLI,
  checkExpression,
